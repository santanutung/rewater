                                    ...
                                    <nav>
                                        ...
                                        <div class="header-menu dosis">
                                            <ul>
                                                ...
                                                <li><a href="about.html">About <img src="{{ asset('/') }}frontend/assets/img/line2.png" alt=""></a></li>
                                                ...
                                                <li><a href="contact.html">Contact<img src="{{ asset('/') }}frontend/assets/img/line2.png" alt=""></a></li>
                                            </ul>
                                        </div>
                                        <!-- End of Header-menu -->
                                    </nav>
