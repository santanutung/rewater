...
@section('content')
    <div class="block full">
        <div class="block-title">
            <h2><strong>Customer Comment</strong> </h2>
                    ...
                    @foreach ($comments as $key => $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ route('admin.newcomments.edit', $item->id) }}" data-toggle="tooltip"
                                ...
                                <form id='delete-form-{{ $item->id }}'
                                    action="{{ route('admin.newcomments.destroy', $item->id) }}" method="post"
                                    class='d-none'>
                                    @csrf
                                    @method('delete')
                                </form>
