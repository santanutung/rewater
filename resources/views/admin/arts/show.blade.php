        ...
        <div class="row">
            <div class="col-xs-12">
                <form id="form-validation" class="form-horizontal form-bordered" method="post"
                    action="{{ isset($art) ? route('admin.arts.update', $art->id) : route('admin.arts.store') }}" enctype="multipart/form-data">
                    @csrf
                    @if (isset($art))
                        @method('PUT')
                    @endif
                    <fieldset>
                        <div class="form-group   @error('category') has-error @enderror" value="{{ $art->name ?? '' }}">
                        ...
                        <div class="form-group   @error('val_art_img') has-error @enderror" value="{{ $art->name ?? '' }}">
                            <label class="col-md-3 control-label" for="val_art_img">Images <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-5">

                                    <input type="file"  id="val_art_img" name="category" class="form-control dropify" data-default-file="{{ $art->val_art_img ?? '' }}"
                                      >
                                    @error('category')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="form-group   @error('extra_images') has-error @enderror" value="{{ $art->extra_images ?? '' }}">
                            <label class="col-md-3 control-label" for="extra_images">Extra Images <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-7">
                                <div class="row">
                                    <div class="col-md-4">
                                         <input type="file" id="extra_images" name="extra_images[]" class="form-control dropify" data-default-file="{{ $art->val_art_img ?? '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <textarea id="art_description"  name="description" rows="9"
                                    class="form-control" placeholder="Description..">{{$art->description ?? ''}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label class="checkbox-inline" for="digital">
                                    <input type="checkbox"
                                    @if($art){{$art->digital==1?"checked":""}} @endif id="digital" name="digital" value="1"> Digital
                                </label>
                                <label class="checkbox-inline" for="physical">
                                    <input type="checkbox" @if($art){{$art->physical==1?"checked":""}} @endif  id="physical" name="physical" value="1"> Physical
                                </label>
                        ...
                        <div class="form-group physical">
                            ...
                            <div class="col-md-7">
                                <textarea id="physical_instructions" name="physical_instructions" rows="9"
                                    class="form-control" placeholder="Instructions for digtal.." > {{$art->physical_instructions ?? ''}} </textarea>
                            </div>
                        </div>
                        <div class="form-group digital">
                            <label class="col-md-3 control-label" for="digital_instructions">Instructions for digtal<span
                                    class="text-danger">*</span></label>
                            <div class="col-md-7">
                                <textarea id="digital_instructions" name="digital_instructions" rows="9"
                                    class="form-control" placeholder="Instructions for digtal..">{{$art->digital_instructions ?? ''}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group physical  @error('physical_art_delivery_time') has-error @enderror"
                            ...
                            <label class="col-md-3 control-label" for="physical_art_delivery_time">physical art delivery date:- <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-5">

                                <input type="text"  id="physical_art_delivery_time" name="physical_art_delivery_time" class="form-control
                                  input-datepicker" data-date-format="mm/dd/yy" placeholder="mm/dd/yy" value="{{ $art->physical_art_delivery_time ?? '' }}">
                        ...
                        <div class="form-group physical   @error('size_physical') has-error @enderror"
                            value="{{ $art->size_physical ?? '' }}">
                            <label class="col-md-3 control-label" for="size_physical">Size of physical :- <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-5">

                                <input type="text" id="size_physical" name="size_physical" class="form-control"
                                    placeholder="Enter size.." value="{{ $art->size_physical ?? '' }}">
                                @error('size_physical')
                                    <span class="help-block">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group physical  @error('frame_color') has-error @enderror"
                            value="{{ $art->frame_color ?? '' }}">
                            <label class="col-md-3 control-label" for="frame_color">Frame color
                                :- <span class="text-danger">*</span></label>
                            <div class="col-md-5">
                                <input type="text" id="frame_color" name="frame_color" class="form-control"
                                    placeholder="Enter color.." value="{{ $art->frame_color ?? '' }}">
                                @error('frame_color')
                                    <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group physical  @error('materia_used_painting') has-error @enderror"
                            ...
                            <label class="col-md-3 control-label" for="materia_used_painting">Material we used in painting
                                :- <span class="text-danger">*</span></label>
                            <div class="col-md-5">
